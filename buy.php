...
<div class="container">
    <h1 class="text-center text-white bg-dark">Order Placed Successfully</h1>
    <br>
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            ...
            if (isset($_POST['submit'])) {
                ...
                $q = "INSERT INTO `orders`(`username`, `email`, `mobile`, `type`) VALUES (?, ?, ?, ?)";
                $stmt = $con->prepare($q);
                $stmt->bind_param("ssss", $username, $email, $mobile, $type);
                $stmt->execute();
                ...
                echo "Your order id is: " . $user['orderid'];
            }
            ?>
        </table>
    </div>
